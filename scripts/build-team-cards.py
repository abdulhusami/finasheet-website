...
ICON = {
    ...
    "in": '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.24 8h4.52V24H.24zM8.98 8h4.33v2.19h.06c.6-1.14 2.07-2.34 4.26-2.34 4.56 0 5.4 3 5.4 6.9V24h-4.52v-6.35c0-1.51-.03-3.46-2.11-3.46-2.11 0-2.44 1.65-2.44 3.35V24H8.98z"/></svg>',
}
...
def vcard(e, url):
    ...
    if e.get("linkedin"):
        lines.append(f"X-SOCIALPROFILE;TYPE=linkedin:{e['linkedin']}")
